...
const AuthLayout = ({ children }) => {
    return (
        <div className="flex">
            <div className="w-screen bg-gradient-to-br from-green-500 via-green-300 to-green-700 h-screen md:w-[60vw] px-12 pt-8 pb-12">
                <h2 className="text-5xl font-medium text-black">Expense Tracker</h2>
                {children}
            </div>
            <div className="hidden md:block w-[40vw] h-screen bg-gradient-to-br from-blue-600 via-purple-800 to-indigo-900 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
